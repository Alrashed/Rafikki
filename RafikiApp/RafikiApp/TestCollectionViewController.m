...
- (void)viewDidLoad {
    ...
    self.moodArray = @[@"Fitness", @"Sports", @"Beauty", @"Therapeutic", @"Instruments", @"Education", @"Photography", @"Automotive"];
    //self.backgroundPhotoNameArray = @[@"mood1.jpg", @"mood2.jpg", @"mood3.jpg", @"mood4.jpg", @"mood5.jpg", @"mood6.jpg", @"mood7.jpg", @"mood8.jpg"];
    self.photoNameArray = @[@"my0.png", @"my1.png", @"my2.png", @"my3.png", @"my4.png", @"my5.png", @"my6.png", @"my7.png"];
