...
- (void) drawWheel {
    ...
    for (int i = 0; i < numberOfSections; i++) {
        ...
        UIImageView *cloveImage = [[UIImageView alloc] initWithFrame:CGRectMake(5, 15, 30, 30)];
        cloveImage.image = [UIImage imageNamed:[NSString stringWithFormat:@"my%i.png", i]];
    ...
    bg.image = [UIImage imageNamed:@"Whilbg.png"];
    [self addSubview:bg];
