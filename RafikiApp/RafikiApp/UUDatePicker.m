...
#pragma mark - Initialization assignment
...
- (void)drawRect:(CGRect)rect
{
    ...
    //Get current date, stores the current time position
...
//Get the current time analysis and position
...
#pragma mark - Agent callback method
...
//According to string return date
...
//Find the number of days each month through the years
...
//Set the number of days per month array
